...
region_for_state = paste0("state:", "01", "+county:*+tract:*")

t <- getCensus(name = "pdb/blockgroup",
                      vintage = 2021,
                      key = "fbbc8b0d3e53089da7cabc380628d6d46ae00444",
                      vars = c("Block_group",
                               "County", 
...
```Med_House_Value_BG_ACS_15_19``` is defined as the "Median of ACS respondents' house value
estimates per block group".
